...
An offline-first baby feeding tracking application built with Nuxt 4 and Vue 3, designed for fast data entry and reliable use without network connectivity.

The app stores data locally using IndexedDB (Dexie) and synchronises with a backend via a service worker, enabling seamless usage both online and offline.

This project also explores AI-assisted development as a way to accelerate implementation while maintaining control over architecture and system behaviour.
